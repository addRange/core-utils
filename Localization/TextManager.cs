...
namespace Localization
{
	public class TextManager : SingletonGameObject<TextManager>
	{
		...
		public void LoadDefault() { Load(DefaultLanguage); }

		public void LoadAsCurrent(SystemLanguage forCurrentLanguage) { Load(forCurrentLanguage); }
		...
		private void OnValidate()
		{
			...
			// Axiom)
			Assert.IsTrue(
				m_supportedLanguages.Contains(SystemLanguage.English),
